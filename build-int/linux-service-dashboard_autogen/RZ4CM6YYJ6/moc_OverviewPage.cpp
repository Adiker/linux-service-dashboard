...
#include "../../../src/widgets/OverviewPage.h"
...
template <> constexpr inline auto OverviewPage::qt_create_metaobjectdata<qt_meta_tag_ZN12OverviewPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'refresh'
        QtMocHelpers::SlotData<void(const ModuleSettings &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'refresh'
...
void OverviewPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->refresh((*reinterpret_cast<std::add_pointer_t<ModuleSettings>>(_a[1]))); break;
