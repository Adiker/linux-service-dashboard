    ...
    : QWidget(parent)
{
    ...
    auto *general = new QGroupBox(QStringLiteral("Refresh"), this);
    ...
    auto *servicesGroup = new QGroupBox(QStringLiteral("Watched systemd services"), this);
    ...
    auto *modules = new QGroupBox(QStringLiteral("Modules"), this);
